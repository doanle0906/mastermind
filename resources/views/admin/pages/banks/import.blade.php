...
@section("title-admin", "Import Banks Information")
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-horizontal form-validate import-banks" method="POST" enctype="multipart/form-data" action="{{ url('/banks/import') }}>
                            @csrf
