...
use App\Models\BqiProductTB;
use App\Repositories\EloquentRepository;
use Exception;
use Illuminate\Support\Facades\DB;

class BqiProductTBRepository extends EloquentRepository implements BqiProductTBRepositoryInterface {
    /**
     * get model
     * @return string
     */
    public function getModel() {
        return BqiProductTB::class;
    }
    ...
    public function updateOrInsertMultipleRow($data) {
        ...
        try {
            ...
            $queryString = 'INSERT INTO bqi_products_tb (type_product, product, `value`, `report_time`, created_at, updated_at) VALUES ';
