...
use App\Models\BqiProductBB;
use App\Repositories\EloquentRepository;
use Exception;
use Illuminate\Support\Facades\DB;

class BqiProductBBRepository extends EloquentRepository implements BqiProductBBRepositoryInterface {
    /**
     * get model
     * @return string
     */
    public function getModel() {
        return BqiProductBB::class;
    }
    ...
    public function updateOrInsertMultipleRow($data) {
        ...
        try {
            ...
            $queryString = 'INSERT INTO bqi_products_bb (bank_id, type_product, `value`, created_at, updated_at) VALUES ';
