...
use App\Models\BqiMonthBB;
use App\Repositories\EloquentRepository;
use Exception;
use Illuminate\Support\Facades\DB;

class BqiMonthBBRepository extends EloquentRepository implements BqiMonthBBRepositoryInterface {
    /**
     * get model
     * @return string
     */
    public function getModel() {
        return BqiMonthBB::class;
    }
    ...
    public function updateOrInsertMultipleRow($data) {
        ...
        try {
            ...
            $queryString = 'INSERT INTO bqi_month_bb (bank_id, type_data, `value`, `report_time`, created_at, updated_at) VALUES ';
